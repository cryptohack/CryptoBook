...
where $$v_i$$ are linearly independent vectors. Collectively, they form a **basis** of$$L$$. 

{% hint style="info" %}
We say a set of vectors $$v_i$$are **linearly independent** if the only solution to the equation $$\sum_{i} a_i v_i = 0$$ is when all $$a_i$$are zero. 
{% endhint %}
